...
import { collection, getDocs, orderBy, query } from "firebase/firestone";
import { db } from "../../Firestone/firebase-config";
    ...
    const Table = styled.table`
        ...
        function TableContainer()  {
            ...
            return (
                <TableWrapper>
                    <Table>
                        <caption className="text-base md:text-x1 p-1">
                            Your Rank : {rank}
                        </caption>
                        <thread className="bg-blue-600 text-base md:text-x1 ">
                            <tr>
                        ...
                        {boardData ? (
                            <tbody className="text-base text-black lg:text-x1 md:text-lg">
