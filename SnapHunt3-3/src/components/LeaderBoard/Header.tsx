...
import dolloar from "../../assets/dollar.png"
...
function Logo(){
    ...
    function Icons(){
        return <div className="flex gap-4 items-center justify-between">
            ...
            <a href="https://github.com/Tribhuwan-Joshi/Snap-Hunt" target="blank" rel="noopener noreferrer" title="github"><img src={git} className="md:w-[36px] lg:w-[40px] w-[24px] cursor-pointer " alt="github"/></a>
